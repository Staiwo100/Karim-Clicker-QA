# Overview (Scope and Key Findings)

We tested both UI bugs and value errors using inspect element to test higher and lower values for functions such as Nayan to find errors.

Some of our key findings were mainly UI errors and performance issues within the game with the performance issues being more severe and critical rather than the UI errors which were completely visual and didn't hinder the games
performance
